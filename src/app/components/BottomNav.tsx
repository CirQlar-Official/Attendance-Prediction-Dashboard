...
import { Home, Plus, TrendingUp, Menu, X, Clock} from 'lucide-react';
...
const tabs = [
  ...
  ...(isAdmin ? [{ path: '/add-data', icon: Plus, label: 'Add Data', strokeWidth: 1.5 }] : []),
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 h-[70px] z-50 ${
      ...
      <div className="relative flex items-center justify-around max-w-[500px] mx-auto px-4 py-[8px] h-full">
        {/* Sliding pill */}
        {activeIndex >= 0 && pillStyle.size > 0 && (
          <div
